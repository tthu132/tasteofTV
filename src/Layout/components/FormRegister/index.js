...
function FormRegister({ formDN, handleCloseFormRegister, openLogin }) {
    ...
    return (
        <div className={classes} >
            <CloseOutlined className={cx('close')} onClick={handleCloseFormRegister} />
            <div className={cx('inner')}>
                ...
                <div className={cx('span')}>
                    <p>Quên mật khẩu</p>
                    <p>Bạn đã có tài khoản?<span onClick={openLogin}>Đăng nhập</span></p>
